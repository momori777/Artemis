...
import torchaudio
# Force sox backend to avoid torchcodec DLL issues on Windows CPU.
# torchaudio >= 2.9 removed set_audio_backend (sox backend deprecated;
# soundfile is the default and works fine), so guard it for compat.
if hasattr(torchaudio, 'set_audio_backend'):
    try:
        torchaudio.set_audio_backend("sox")
    except Exception:
        pass  # sox unavailable; soundfile default is used

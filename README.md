...
<head>
<meta charset="UTF-8">
<title>AI Girlfriend — Readme</title>
<style>
*{margin:0;padding:0;box-sizing:border-box}
body{font-family:'Inter','Segoe UI',system-ui,-apple-system,sans-serif;background:#0a0a0f;color:#e0dff0;min-height:100vh;display:flex;align-items:center;justify-content:center;overflow-x:hidden}
.container{text-align:center;padding:2.5rem 1.5rem;max-width:520px;width:100%}
.logo{font-size:2.6rem;margin-bottom:.3rem;letter-spacing:-.03em}
.logo span{background:linear-gradient(135deg,#7c5bf5,#f55b6e);-webkit-background-clip:text;-webkit-text-fill-color:transparent}
.subtitle{color:#8888a0;font-size:.95rem;margin-bottom:2.5rem;line-height:1.6}
.cards{display:flex;flex-direction:column;gap:.75rem}
.card{display:flex;align-items:center;gap:1rem;background:#12121a;border:1px solid #2a2a3a;border-radius:12px;padding:1rem 1.25rem;text-decoration:none;color:#e0dff0;transition:all .2s ease;position:relative;overflow:hidden}
.card::before{content:'';position:absolute;inset:0;background:linear-gradient(135deg,rgba(124,91,245,.25),transparent 60%);opacity:0;transition:opacity .2s}
.card:hover{border-color:#7c5bf5;transform:translateY(-1px);box-shadow:0 4px 24px rgba(124,91,245,.25)}
.card:hover::before{opacity:1}
.card-icon{font-size:1.6rem;flex-shrink:0;width:2.4rem;text-align:center}
.card-text{text-align:left}
.card-title{font-size:1.05rem;font-weight:600;display:flex;align-items:center;gap:.5rem}
.card-desc{font-size:.82rem;color:#8888a0;margin-top:.15rem}
.card-arrow{margin-left:auto;color:#8888a0;font-size:.85rem;transition:transform .2s,color .2s;flex-shrink:0}
.card:hover .card-arrow{transform:translateX(4px);color:#7c5bf5}
.footer{margin-top:2rem;font-size:.78rem;color:#8888a0}
.footer a{color:#7c5bf5;text-decoration:none}
.footer a:hover{text-decoration:underline}
@media(max-width:480px){.container{padding:1.5rem 1rem}.logo{font-size:2rem}}
</style>
</head>
<body>
<div class="container">
  <div class="logo"><span>AI Girlfriend</span></div>
  <p class="subtitle">Select Language / 选择语言 / 言語を選択</p>
  <div class="cards">
    <a class="card" href="README_CN.md">
      <div class="card-icon">🇨🇳</div>
      <div class="card-text">
        <div class="card-title">中文</div>
        <div class="card-desc">简体中文 · 完整文档</div>
      </div>
    ...
    <a class="card" href="README.md">
      ...
      <div class="card-text">
        ...
        <div class="card-desc">English · Full documentation</div>
      </div>
      <div class="card-arrow">→</div>
    </a>
    <a class="card" href="README_jp.md">
      <div class="card-icon">🇯🇵</div>
      <div class="card-text">
        <div class="card-title">日本語</div>
        <div class="card-desc">日本語 · 完全なドキュメント</div>
      </div>
      <div class="card-arrow">→</div>
    </a>
  </div>
  <div class="footer">
    100% 本地 · 完全隐私 · 零 API 依赖<br>
    <a href="https://github.com/TAOTAO777/ai-girlfriend-natsume" target="_blank">GitHub Repository →</a>
  </div>
</div>
</body>
</html>

...
🔴 **Fatal: local model output cap is 8192 tokens.** TTS / image requests must execute sessions_spawn as the first tool call, then text can follow. Sending long text before spawn causes truncation and lost calls!

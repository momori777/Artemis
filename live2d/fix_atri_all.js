const fs=require('fs');
const path='C:/Users/TK/.openclaw/workspace/live2d/model/atri/atri.model3.json';
...
// Check if Motions_face_0_File_0.json exists, if not, we need to create/rename
const face0path='C:/Users/TK/.openclaw/workspace/live2d/model/atri/Motions_face_0_File_0.json';
if(!fs.existsSync(face0path)){
  console.log('Motions_face_0_File_0.json missing, copying from hair_0');
  fs.copyFileSync('C:/Users/TK/.openclaw/workspace/live2d/model/atri/Motions_hair_0_File_0.json', face0path);
}

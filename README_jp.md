...
| モデル | 用途 | サイズ |
|-|-|-|
| **LuffyTheFox Qwen3.6-35B-A3B Genesis Hermes V5 APEX Compact** (GGUF) | チャット LLM | 16.11 GB |
...
llama.cpp 経由で LuffyTheFox Qwen3.6-35B-A3B Genesis Hermes V5 (MoE, 16.10 GiB, 34.66B パラメータ) を実行。

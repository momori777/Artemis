...
class TTSTab(QWidget):
    ...
    def _setup_ui(self):
        ...
        # Add default (ref_wavs) as "夏目(Natsume)"
        ...
        opts_layout.addWidget(QLabel("角色:"), 0, 0)
